...
<div class="mdui-container">
    <div class="vContainer">
        <div class="mdui-row">
            <div class="pageBody mdui-col-md-10 shadow-2 mdui-col-offset-md-1 borR5px" style="padding-right:2%;padding-left:2%;">
                <div class="mdui-typo pageHead" style="text-align: center;">
                    <h2 style="text-align: center;" class="topLx"><?php $this->title() ?></h2>
                    <div class="taptap">
                        <div>
