                                    ...
                                    <div class="boaCon marCenter">
                                        <ul class="reply-comments">
                                            ...
                                            <?php while($comments->next()): ?>
                                                <li>
                                                    <?php $domain = strstr($comments->mail, 'qq'); if($domain) {?> <img class="avatar" width="50" height="50" src="http://q1.qlogo.cn/g?b=qq&nk=<?php echo substr($comments->mail, 0, strpos($comments->mail, '@')); ?>&s=640" /><?}else { $comments->gravatar('50', '');} ?>
